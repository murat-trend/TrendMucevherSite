...
// KİLİT 3D önizleme — zincir viewer kalıbının kilit evi kopyası.
...
export function KilitViewer({ meshes, maden, fitKey, mod = "mat" }: {
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === "development") {
      (window as unknown as Record<string, unknown>).__kilitDebug = { scene, camera, renderer, group, controls };
    }
