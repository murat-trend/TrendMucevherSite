// KİLİT MOTORU — CSG KÖPRÜSÜ (manifold-3d WASM; kilit evinin kendi kopyası)
// WASM disiplini: her ara Manifold'a delete() (GC yok — sızıntı).

export type KilitMesh = { positions: Float64Array; indices: Uint32Array };
...
export function meshToManifold(w: any, m: KilitMesh): any {
...
export function manifoldToMesh(mf: any): KilitMesh {
...
export function isaretliHacim(m: KilitMesh): number {
