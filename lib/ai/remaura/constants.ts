...
Sistem şunları Avoid olarak ekler: plastic look, flat metal texture, blurry edges, low quality, cartoonish, dull reflections, shallow blur on the piece, low resolution. Sen bunların TERSİNİ vurgula – photorealistic metal, sharp focus, high quality, lifelike reflections.
...
JSON formatında döndür (sadece JSON):
{
  ...
  "lighting": "kullanıcının istediği ışık – yüksek kontrast/dramatik ise high contrast, chiaroscuro; belirtmediyse directional high-contrast studio lighting, crisp hard edges",
...
- Keskin hatlar: yumuşak silüet, bulanık kenar, muddy metal geçişi veya fuzzy outline ASLA isteme — crisp hard edges zorunlu
...
YASAK: black background, reflective surface, overly busy composition, merged details, muddy lines, extreme detail density, mushy edges, blurry outlines, washed-out silhouettes.
...
JSON formatında döndür (sadece JSON):
{
  ...
  "ornamentEngraving": "süsleme",
  "craftsmanshipLanguage": "işçilik",
  "lighting": "directional studio lighting, hard silhouette edges, crisp relief separation",
...
Görselden şu parametreleri DETAYLI çıkar (JSON formatında döndür, sadece JSON). Her alanı doldur:
{
  ...
  "lightAtmosphere": "hard-edged studio / dramatik gölge / yansımalı / flat – ışık nasıl",
  ...
  "lightingDirection": "upper left / frontal / rim light / chiaroscuro – ışık yönü",
  "shadowStyle": "hard-edged / crisp contact / dramatic / minimal – gölge stili"
}
